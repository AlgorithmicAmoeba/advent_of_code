...
def parse_parsed(packet):
    ...
    match t:
        ...
        case 0:
            return sum([parse_parsed(p) for p in r])

        case 1:
            return numpy.prod([parse_parsed(p) for p in r])

        case 2:
            return min([parse_parsed(p) for p in r])

        case 3:
            return max([parse_parsed(p) for p in r])

        case 5:
            l, r = [parse_parsed(p) for p in r]
